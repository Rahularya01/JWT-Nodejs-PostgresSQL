...
var TaskController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, prisma_1.default.tasks.findMany({
                                where: {
                                    userId: userID,
                                },
                            })];
    ...
    TaskController.prototype.createTask = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userID, _a, name, completed, task, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userID = req.userID.userID;
                        _a = req.body, name = _a.name, completed = _a.completed;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, prisma_1.default.tasks.create({
                                data: {
                                    name: name,
                                    completed: completed,
                                    userId: userID,
    ...
    TaskController.prototype.updateTask = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userID, completed, id, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userID = req.userID.userID;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, prisma_1.default.tasks.updateMany({
                                data: {
                                    completed: completed,
                                },
                                where: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, prisma_1.default.tasks.deleteMany({
                                where: {
                                    id: id,
                                    userId: userID,
                                },
