...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.register = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, hashedPassword, user, token, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        user = _b.sent();
                        token = jsonwebtoken_1.default.sign({ userID: user.id }, process.env.JWT_TOKEN);
    ...
    UserController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, user, passwordMatch, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        token = jsonwebtoken_1.default.sign({ userID: user === null || user === void 0 ? void 0 : user.id }, process.env.JWT_TOKEN);
                        res.status(200).json({ token: token });
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _b.sent();
